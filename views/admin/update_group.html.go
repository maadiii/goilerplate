...
// source: /home/maadi/workspace/goilerplate/views/admin/update_group.html
// DO NOT EDIT!
package adminview
...
func UpdateGroup(group types.GroupWithSelectedRoles, user *models.User, buffer *bytes.Buffer) {
...
<input type="hidden" value="`)
	...
	buffer.WriteString(`" id="group-id">
    <div class="form-row">
        <div class="col-sm-12 col-md-4 col-lg-3 mb-3">
            <label for="name">نام گروه کاربری :</label>
            <input type="text" value="`)
	hero.EscapeHTML(group.Name, buffer)
	buffer.WriteString(`" class="form-control" id="name" minlength="3" maxlength="64"
        ...
        window.addEventListener('load', function () {
            ...
            form.addEventListener('submit', function (event) {
                ...
                if (form.checkValidity() === false || !checked()) {
                    ...
                    let request = new Ajax('/apiv1/admin/groups', group, 'PATCH')
                    request.post((result) => {
                        switch (result.status) {
                            ...
                            case 409:
                                ...
                                break
                            case 700:
                                errorToast('شما نمی‌توانید گروه ادمین را ویرایش کنید.')
                        }
                    });
                }
