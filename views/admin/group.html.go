...
// source: /home/maadi/workspace/goilerplate/views/admin/group.html
// DO NOT EDIT!
package adminview
...
func Group(group presenters.GroupAlongRolesAndUsersPresent, user *models.User, buffer *bytes.Buffer) {
...
<section>
	...
	buffer.WriteString(`" class="form-control" id="description" minlength="16"
                    maxlength="128" placeholder="توضیحات" pattern="[.پچجحخهعغفقثصضشسیبلاتنمکگوئدذرزطظژؤإأءًٌٍَُِّ\s]+$"
                    disabled>
                <label style="margin-top: 20px;">نقش های کاربری :</label>
                <ul class="ks-cboxtags" style="position: relative; top: -20px;">
                    `)
	for _, role := range group.Roles {
		...
		buffer.WriteString(`" checked disabled>
                        <label for="`)
		hero.EscapeHTML(role.EnName, buffer)
		buffer.WriteString(`">`)
	...
	buffer.WriteString(`
        ...
        <label style="position: relative; top: -30px;">کاربران :</label>
		...
		buffer.WriteString(`
            <div class="col-md-2">
                <div class="card card-primary">
                    <div class="card-body">
                        <strong>`)
		hero.EscapeHTML(user.FullName, buffer)
		buffer.WriteString(`</strong>
                        <hr>
                        <p class="text-muted">`)
		hero.EscapeHTML(user.MobileNumber, buffer)
		buffer.WriteString(`</p>
                    </div>
                </div>
            </div>
