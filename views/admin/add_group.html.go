...
// source: /home/maadi/workspace/goilerplate/views/admin/add_group.html
// DO NOT EDIT!
package adminview
...
func AddGroup(rl []models.Role, user *models.User, buffer *bytes.Buffer) {
        ...
        window.addEventListener('load', function () {
            ...
            form.addEventListener('submit', function (event) {
                ...
                if (form.checkValidity() === false || !checked()) {
                    ...
                    let request = new Ajax('/apiv1/admin/groups', group)
                    request.post((result) => {
