...
// source: /home/maadi/workspace/goilerplate/views/admin/user_list.html
// DO NOT EDIT!
package adminview
...
<head>
  ...
  <title>
    `)
	buffer.WriteString(` لیست کاربران `)
...
<div class="row">
	...
	if s == "" {
		...
		buffer.WriteString(`
                        <input type="text" id="searchbox1" style="width: 110px;" name="table_search"
                            class="form_control float-right" placeholder="جستجو" value="`)
	...
	for i, user := range users {
		buffer.WriteString(`
                        <tr>
                            <td>`)
		hero.EscapeHTML(strconv.Itoa((i+1)+((page-1)*10)), buffer)
		...
		buffer.WriteString(`</td>
                            <td>`)
		hero.EscapeHTML(user.GroupName, buffer)
		buffer.WriteString(`</td>
                            <td>Operation</td>
                        </tr>
                        `)
	...
	if page != 1 {
		buffer.WriteString(`
                    <li class="page-item"><a class="page-link"
                            href="/accounts?page=`)
		hero.EscapeHTML(strconv.Itoa(page-1), buffer)
		buffer.WriteString(`&search=`)
		hero.EscapeHTML(s, buffer)
		buffer.WriteString(`">«</a></li>
                    <li class="page-item"><a class="page-link" href="/accounts?page=1&search=`)
		hero.EscapeHTML(s, buffer)
		buffer.WriteString(`">۱</a>
                    </li>
	...
	hero.EscapeHTML(strconv.Itoa(page), buffer)
	buffer.WriteString(`</a></li>
                    `)
	if lp != page && lp != 0 {
		buffer.WriteString(`
                    ...
                    <li class="page-item"><a class="page-link"
                            href="/accounts?page=`)
		hero.EscapeHTML(strconv.Itoa(lp), buffer)
		buffer.WriteString(`&search=`)
		hero.EscapeHTML(s, buffer)
		buffer.WriteString(`">`)
		hero.EscapeHTML(strconv.Itoa(lp), buffer)
