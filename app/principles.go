...
func (a *App) CreateRefreshToken(userid uuid.UUID) (string, error) {
...
func (a *App) ReadCookie(r *http.Request, name string) (string, error) {
	secureCookie := a.secureCookie()
